...
void PromptInstruction(NextFit& bf);
void ProcessInstruction(NextFit& bf, const char& instr, const int32_t& arg = -1);
...
*/
void ProcessInstruction(NextFit& bf, const char& instr, const int32_t& arg)
{
	switch (instr)
	{
	case 'p':
